              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <div className="inline-block rounded-lg bg-[#00f5d5] px-3 py-1 text-sm text-[#121212] font-medium">
                    SEO & Digital Marketing / تحسين محركات البحث والتسويق الرقمي
                  </div>
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">SEO & Digital Marketing</h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed">
                    Increase your online visibility and drive targeted traffic.
                  </p>
                </div>
