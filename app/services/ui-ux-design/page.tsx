            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">UI/UX Design</h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed">
                    Intuitive interfaces and seamless experiences that users love.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-[#121212]/70 md:text-xl/relaxed">
                  Let's create interfaces that delight your users.
                </p>
              </div>
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                <Button className="bg-[#00f5d5] text-[#121212] hover:bg-[#00f5d5]/80">
