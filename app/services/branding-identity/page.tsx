              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <div className="inline-block rounded-lg bg-[#00f5d5] px-3 py-1 text-sm text-[#121212] font-medium">
                    Branding & Identity Design / تصميم الهوية والعلامة التجارية
                  </div>
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">Branding & Identity Design</h1>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-[#121212]/70 md:text-xl/relaxed">
                  Let's create a brand identity that makes you stand out.
                </p>
              </div>
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                <Button className="bg-[#00f5d5] text-[#121212] hover:bg-[#00f5d5]/80">
